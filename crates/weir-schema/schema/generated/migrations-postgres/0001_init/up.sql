CREATE TABLE dead_letters (id UUID PRIMARY KEY NOT NULL, tenant_id TEXT NOT NULL DEFAULT 'default', connection TEXT NOT NULL, stream TEXT NOT NULL, record TEXT NOT NULL, reason TEXT NOT NULL, ts BIGINT NOT NULL);

CREATE TABLE stream_state (tenant_id TEXT NOT NULL DEFAULT 'default', connection TEXT NOT NULL, stream TEXT NOT NULL, cursor TEXT, opaque BYTEA NOT NULL, PRIMARY KEY (tenant_id, connection, stream));
...
CREATE TABLE outbox (id UUID PRIMARY KEY NOT NULL, tenant_id TEXT NOT NULL DEFAULT 'default', connection TEXT NOT NULL, stream TEXT NOT NULL, seq BIGINT NOT NULL, processed INTEGER NOT NULL);

CREATE TABLE run_logs (id UUID PRIMARY KEY NOT NULL, tenant_id TEXT NOT NULL DEFAULT 'default', connection TEXT NOT NULL, stream TEXT NOT NULL, level TEXT NOT NULL, message TEXT NOT NULL, ts BIGINT NOT NULL);
